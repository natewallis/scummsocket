...
echo บ                                                               บ
echo บ                         MONKEY ISLAND                         บ
echo บ                                                               บ
echo บ                   Hard Disk Install Utility                   บ
echo บ                                                               บ
echo บ                                                               บ
echo บ This program will install all files into a directory          บ
echo บ called "MONKEY" on drive %1.  If you do not wish to do this,  บ
echo บ then press Ctrl-C now.                                        บ
echo บ                                                               บ
